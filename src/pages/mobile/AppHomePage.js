  ...
  return (
    <div className="relative min-h-screen">
      <CSSTransition in={isLoaded} classNames="fade-in" timeout={1000} unmountOnExit>
        <h1 className="absolute top-10 left-1/2 transform -translate-x-1/2 z-10 text-customTextColor text-3xl font-bold text-center md:text-4xl lg:text-5xl" style={{
          fontSize: "1.5rem",
      ...
      <div className="flex justify-center">
        <CSSTransition in={isLoaded} classNames="fade-in" timeout={1000} unmountOnExit>
          <img
            src="/Group.png"
            alt="Group"
            className="relative z-10 object-contain mt-36 md:mt-20 lg:mt-36 md:w-3/4 lg:w-2/4 mx-auto"
          />
        </CSSTransition>
      </div>
      <div className="mt-40 md:mt-20 lg:mt-36 text-center">
        <CSSTransition in={isLoaded} classNames="fade-in" timeout={1000} unmountOnExit>
          <h2 className="text-2xl font-bold mb-2 text-customTextColor md:text-3xl lg:text-4xl">Mental Harmony</h2>
        </CSSTransition>
        <CSSTransition in={isLoaded} classNames="fade-in" timeout={1000} unmountOnExit>
      ...
      <div className="absolute bottom-0 left-0 w-full py-8">
        <div className="flex justify-center">
          <CSSTransition in={isLoaded} classNames="fade-in" timeout={1000} unmountOnExit>
            <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 w-full md:w-auto mx-4 rounded-full">
              Join Now
            </button>
          </CSSTransition>
        </div>
